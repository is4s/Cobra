...
Cobra
    ...
    |:----------------------------------------------------- |:------------------------------------- | ---------------------- |:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    | {ref}`Cobra API <cobra_api>`                          | `pntos-api/src/pntos/api/`            | `pntos.api`            | An {term}`API` written in Python that defines a Position, Navigation, and Timing Operating System ({term}`pntOS`). Consists of [abstract plugin definitions](https://github.com/is4s/cobra/tree/main/pntos-api/src/pntos/api/plugins). |
