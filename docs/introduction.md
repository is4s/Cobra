...
plugins, the [Cobra](https://github.com/is4s/cobra) repository provides not only a
...
[here](https://github.com/is4s/cobra/blob/main/pntos-cobra-apps/src/pntos/apps/tutorial/pos_ins.py).
...
[found here](https://github.com/is4s/cobra/blob/main/pntos-cobra/src/pntos/cobra/dummy_plugins/DummyTransportPlugin.py).
...
[found here](https://github.com/is4s/cobra/blob/main/pntos-cobra/src/pntos/cobra/dummy_plugins/DummyControllerPlugin.py),
along with its {py:obj}`DummyMediator<pntos.cobra.internal.DummyMediator>`
[here](https://github.com/is4s/cobra/blob/main/pntos-cobra/src/pntos/cobra/dummy_plugins/DummyMediator.py).
...
here](https://github.com/is4s/cobra/blob/main/pntos-cobra/src/pntos/cobra/dummy_plugins/DummyOrchestrationPlugin.py)
...
[`DummyOrchestrationPlugin`](https://github.com/is4s/cobra/blob/main/pntos-cobra/src/pntos/cobra/dummy_plugins/DummyOrchestrationPlugin.py).
```
